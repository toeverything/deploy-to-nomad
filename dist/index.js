...
const nomad_1 = __nccwpck_require__(4269);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const nomadDomain = core.getInput('nomad-domain');
            ...
            if (!nomadACL || !cfClientId || !cfClientSecret) {
                throw new Error(`${[nomadACL, cfClientId, cfClientSecret]
                    .filter(a => !!a)
                    .join(',')} is/are not exist.`);
            }
            (0, request_1.configRequest)({
                nomadDomain,
                nomadACL,
                cfClientId,
                cfClientSecret
            });
            const ret = yield (0, nomad_1.createOrRunJob)({
                id: jobId,
                staticPort,
                containerPort,
                image: imageUrl
...
function listJobs() {
    return __awaiter(this, void 0, void 0, function* () {
        const jobs = yield (0, request_1.request)({
            url: '/v1/jobs',
            method: 'GET'
        });
...
function getJobInfo(jobId) {
    return __awaiter(this, void 0, void 0, function* () {
        const jobInfo = (yield (0, request_1.request)({
            url: `/v1/job/${jobId}`,
            method: 'GET'
        })).data;
...
function getAllJobs() {
    return __awaiter(this, void 0, void 0, function* () {
        const jobIds = yield listJobs();
        const jobsInfo = yield Promise.all(jobIds.map((jobId) => __awaiter(this, void 0, void 0, function* () { return getJobInfo(jobId); })));
        return jobsInfo;
    });
}
function createJobHCL(options) {
    return `
job "${options.id}" {
  region      = "global"
  datacenters = ["scholar"]
...
function parseHCLtoJobJSON(options) {
    return __awaiter(this, void 0, void 0, function* () {
        const hcl = createJobHCL(options);
        const jobJSON = (yield (0, request_1.request)({
...
function runJob(jobJSON) {
    return __awaiter(this, void 0, void 0, function* () {
        const ran = (yield (0, request_1.request)({
            url: `/v1/jobs`,
            method: 'POST',
            data: {
                Job: jobJSON
...
function createOrRunJob(options) {
    return __awaiter(this, void 0, void 0, function* () {
...
`);
        ...
        const jobJSON = yield parseHCLtoJobJSON(options);
        const ret = yield runJob(jobJSON);
        return ret;
    });
}
exports.createOrRunJob = createOrRunJob;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.configRequest = exports.request = void 0;
